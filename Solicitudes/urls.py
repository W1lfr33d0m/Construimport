...
urlpatterns = [
    ...
    path('solicitud_ppa/add/', Agregar_Solicitud_PPA.as_view([FSolicitud_PPA, FSolicitud_PPA_Proxy]), name='solicitud_ppa'),
    path('solicitud_neumatico/add/', Agregar_Solicitud_Neumatico.as_view([FSolicitud_Neumatico, FSolicitud_Neumatico_Proxy]), name='solicitud_neumatico'),
    path('solicitud_bateria/add/', Agregar_Solicitud_Bateria.as_view([FSolicitud_Bateria, FSolicitud_Bateria_Proxy]), name='solicitud_bateria'),
