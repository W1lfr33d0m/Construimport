    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechasol', models.DateField(default=datetime.date(2022, 2, 6), validators=[Solicitudes.models.validate_fecha])),
                ('cantidad', models.IntegerField(blank=True, null=True, validators=[Solicitudes.models.validate_cantidad])),
                ('aprobada', models.BooleanField(default=False)),
                ('idproducto', models.ForeignKey(db_column='idproducto', on_delete=django.db.models.deletion.DO_NOTHING, to='Nomencladores.producto')),
                ('numcontratocliente', models.ForeignKey(db_column='numcontratocliente', on_delete=django.db.models.deletion.DO_NOTHING, to='Nomencladores.cliente')),
                ('numcontratoproveedor', models.ForeignKey(blank=True, db_column='numcontratoproveedor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Nomencladores.proveedor')),
            ],
            options={
