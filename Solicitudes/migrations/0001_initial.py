    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechasol', models.DateField(default=datetime.date(2022, 4, 28), verbose_name='Fecha de la Solicitud')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, max_length=150, null=True, verbose_name='Observaciones')),
                ('valor_estimado', models.FloatField(max_length=10, verbose_name='Valor Estimado')),
                ('idespecialista', models.ForeignKey(db_column='idespecialista', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='COMEX.especialistacomex', verbose_name='Especialista COMEX')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='solicitud_equipo',
            name='idespecialista',
            field=models.ForeignKey(db_column='idespecialista', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='COMEX.especialistacomex', verbose_name='Especialista COMEX'),
        ),
        migrations.AddField(
            model_name='solicitud_equipo',
            name='numcontratocliente',
