    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechasol', models.DateField(default=datetime.date(2022, 4, 9), validators=[Solicitudes.models.validate_fecha], verbose_name='Fecha')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cantidad', models.IntegerField(validators=[Solicitudes.models.validate_cantidad])),
                ('codmincex', models.ManyToManyField(to='Nomencladores.Proveedor', verbose_name='Proveedor')),
