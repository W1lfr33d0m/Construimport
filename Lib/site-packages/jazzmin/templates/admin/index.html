...
{% load i18n static jazzmin Dashboard %}
...
{% block content_title %} {% trans 'Página Principal' %} {% endblock %}
...
{% block content %}
    ...
    <script type="application/javascript">
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Cantidad de Solicitudes Aprobadas Mensualmente según su Categoría'
            },
            xAxis: {
                categories: [
                    'Enero',
            ...
            series: [{
                name: 'Equipos',
                data: ["{{ get_solicitudes_mensuales }}"]
        
            }, {
                name: 'Partes y Piezas',
                data: ["{{ get_solicitudes_mensuales.ppa }}"]
        
            }, {
                name: 'Neumáticos',
                data: ["{{ get_solicitudes_mensuales.nm }}"]
        
            }, {
                name: 'Baterías',
                data: ["{{ get_solicitudes_mensuales.bt }}"]
