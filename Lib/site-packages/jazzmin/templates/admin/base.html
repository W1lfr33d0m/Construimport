...
<head>
    ...
    <!--<script src="{% static "jazzmin/js/code/highcharts.js" %}"></script>
    <script src="{% static "jazzmin/js/code/modules/exporting.js" %}"></script>
    <script src="{% static "jazzmin/js/code/modules/export-data.js" %}"></script>
    <script src="{% static "jazzmin/js/code/modules/accessibility.js" %}"></script>-->
    ...
    {% if not is_popup %}
        ...
        {% if jazzmin_settings.show_sidebar %}
            ...
            <aside class="main-sidebar elevation-4 {{ jazzmin_ui.sidebar_classes }}" id="jazzy-sidebar">
                <a href="{% url 'Dashboard:dashboard' %}" class="brand-link {{ jazzmin_ui.brand_classes }}" id="jazzy-logo">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column {{ jazzmin_ui.sidebar_list_classes }}" data-widget="treeview" role="menu" data-collapsible="false">
                            ...
                            {% if jazzmin_settings.navigation_expanded %}
                                {% for app in side_menu_list %}
                                    ...
                                    {% endfor %}
                                {% endfor %}
                                        <li class="nav-header">Salvas y Restauras</li>
                                        <li class="nav-item">
                                            <a href="/db_save" class="nav-link">
                                                <i class="fas fa-download"></i>
                                                <p>Salvar y Restaurar Información</p>
                                            </a>
                                        </li>
                                    </ul>       
                            {% else %}
                            ...
                            {% endif %}
                                <!--<ul class="nav nav-treeview" style="display: none;">
                                    <li class="nav-item">
                                        <a href="/db_restore" class="nav-link">
