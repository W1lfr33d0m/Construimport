...
body {
    background-image: url("/static/jazzmin/img/FONDOS DE ESCRITORIO-02.jpg");
}
...
.select2-selection--choice--display{
...
body.index {
    background-image: url("/static/jazzmin/img/fondo_admin.jpg");
}

.main-footer {
    background-image: url("/static/jazzmin/img/trama gráfica-03.png");
}
...
body.jazzmin-login-page {
    background-image: url("/static/jazzmin/img/FONDOS DE ESCRITORIO-04-2.jpg");
