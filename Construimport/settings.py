"""
Django settings for Construimport project.
...
JAZZMIN_SETTINGS = {
    ...
    'icons': {
        ...
        'Nomencladores.Ministerio': 'fas fa-landmark',
        'Nomencladores.OSDE': 'fas fa-building',
        'Nomencladores.Cliente': 'fas fa-industry',
        'Nomencladores.UM': 'fas fa-ruler',
...
ROOT_URLCONF = 'Construimport.urls'
...
WSGI_APPLICATION = 'Construimport.wsgi.application'
