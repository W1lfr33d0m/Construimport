# Generated by Django 4.0.1 on 2022-06-27 10:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0007_alter_cliente_fecha_caducidad_alter_cliente_telefono_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='cliente',
            name='fecha_contrato',
            field=models.DateTimeField(default=datetime.datetime(2022, 6, 27, 10, 5, 31, 452413)),
        ),
        migrations.AlterField(
            model_name='cliente',
            name='telefono',
