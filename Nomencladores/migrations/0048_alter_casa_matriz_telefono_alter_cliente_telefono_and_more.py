...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0047_alter_casa_matriz_telefono_alter_pais_nompais_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='telefono',
            field=models.IntegerField(validators=[Nomencladores.models.validate_telefono], verbose_name='Teléfono'),
        ),
        migrations.AlterField(
            model_name='cliente',
            name='telefono',
