# Generated by Django 4.0.1 on 2022-06-11 10:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0078_alter_cliente_telefono_alter_ministerio_telefono_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='telefono',
            field=models.BigIntegerField(max_length=12, validators=[Nomencladores.models.validate_telefono], verbose_name='Teléfono'),
        ),
        migrations.AlterField(
            model_name='cliente',
            name='telefono',
