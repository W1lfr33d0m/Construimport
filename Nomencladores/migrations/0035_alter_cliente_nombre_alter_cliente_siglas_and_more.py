# Generated by Django 4.0.1 on 2022-07-06 16:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0034_alter_bateria_descripcion_alter_cliente_nombre_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='cliente',
            name='telefono',
            field=models.PositiveIntegerField(max_length=8, unique=True, validators=[Nomencladores.models.validate_telefono], verbose_name='Teléfono'),
        ),
        migrations.AlterField(
