# Generated by Django 4.0.1 on 2022-05-27 09:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0055_alter_cliente_telefono_alter_ministerio_telefono_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='baterias',
            field=models.ManyToManyField(null=True, to='Nomencladores.Bateria', verbose_name='Baterías'),
        ),
        migrations.AlterField(
            model_name='proveedor',
            name='equipos',
            field=models.ManyToManyField(null=True, to='Nomencladores.Equipo', verbose_name='Equipos'),
        ),
        migrations.AlterField(
            model_name='proveedor',
            name='neumaticos',
            field=models.ManyToManyField(null=True, to='Nomencladores.Neumatico', verbose_name='Neumáticos'),
        ),
        migrations.AlterField(
            model_name='proveedor',
            name='ppa',
            field=models.ManyToManyField(null=True, to='Nomencladores.PPA', verbose_name='Partes, Piezas y Accesorios'),
        ),
        migrations.AlterField(
