# Generated by Django 4.0.1 on 2022-07-06 16:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nomencladores', '0032_alter_cliente_nombre_alter_cliente_siglas_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='bateria',
            name='idproducto',
            field=models.CharField(max_length=15, primary_key=True, serialize=False, validators=[Nomencladores.validators.ProductoValidator.idproducto_validator], verbose_name='Código'),
        ),
        migrations.AlterField(
            model_name='cliente',
            name='nombre',
